        ...
        public async Task InvokeAsync(HttpContext context)
        {
            try
            {
                ...
                if (IsRequestAllowed(context) == false)
                {
                    ...
                    var response = new
                      APIExceptions((int)HttpStatusCode.TooManyRequests, "Rate limit exceeded", "You have exceeded the number of requests allowed. Please try again later.");
            ...
            catch (Exception ex)
            {
                ...
                var response = _environment.IsDevelopment() ?
                    ...
                    : new APIExceptions((int)HttpStatusCode.InternalServerError, "Internal Server Error", "Something went wrong");
